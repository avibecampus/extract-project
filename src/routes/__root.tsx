  ...
  head: () => ({
    meta: [
      ...
      { title: "A Vibe Campus — Study smarter, grow faster" },
      {
        name: "description",
        content:
          "A Vibe Campus is the all-in-one student growth OS — plan study sessions, chat with an AI coach, ace practice tests, and map your career.",
      },
      ...
      },
      {
        property: "og:image",
        content:
          "https://pub-bb2e103a32db4e198524a2e9ed8f35b4.r2.dev/f1c168ec-b7b2-438f-9215-e17dcae62243/id-preview-ed91ef0b--32970b97-9460-4bbd-a225-845e17f2301b.lovable.app-1783602333271.png",
      },
      {
        name: "twitter:image",
        content:
